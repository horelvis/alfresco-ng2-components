...
describe('Start Task', () => {
    ...
    it('[C290166] Should be possible to cancel a task', () => {
        ...
        tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(standaloneTaskName);
    });
    ...
    it('[C290180] Should be able to create a new standalone task', () => {
        ...
        startTask.addName(standaloneTaskName)
                 ...
                 .addPriority('50')
                 .clickStartButton();
        tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(standaloneTaskName);
    });
    ...
    it('[C291956] Should be able to create a new standalone task without assignee', () => {
        ...
        tasksCloudDemoPage.editTaskFilterCloudComponent()
            ...
            .clearAssignment();
        tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(unassignedTaskName);
    });
