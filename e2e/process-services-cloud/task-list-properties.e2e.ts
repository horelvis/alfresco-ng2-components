...
describe('Edit task filters and task list properties', () => {
    ...
    describe('Edit task filters and task list properties', () => {
        ...
        it('[C292004] Filter by appName', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(createdTask.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(notDisplayedTask.entry.name);
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(notDisplayedTask.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(createdTask.entry.name);
        });
        ...
        it('[C297480] Should be able to see only tasks that are part of a specific process when processInstanceId is set', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(processInstance.entry.id);
        });
        ...
        it('[C297478] Should be able to see only tasks that are assigned to a specific user when assignee is set', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(createdTask.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(notAssigned.entry.name);
        });
        ...
        it('[C297482] Should be able to see only tasks with specific priority when priority is set', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(priorityTask.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(createdTask.entry.name);
        });
        ...
        it('[C297481] Should be able to see only tasks with specific parentTaskId when parentTaskId is set', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(subTask.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsNotDisplayed(createdTask.entry.name);
        });
        ...
        it('[C297486] Filter by Owner', () => {
            ...
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(notAssigned.entry.name);
            tasksCloudDemoPage.taskListCloudComponent().checkContentIsDisplayed(createdTask.entry.name);
